...
type IndexOf<T extends any[], U, C extends any[] = []> = T extends [
  infer Head,
  ...infer Tail
]
  ? Equal<Head, U> extends true
    ? C["length"]
    : IndexOf<Tail, U, [any, ...C]>
  : -1
type Unique<T, U = never, UU extends any[] = []> = T extends [
  infer Head,
  ...infer Tail
]
  ? IndexOf<UU, Head> extends -1
    ? [Head, ...Unique<Tail, U | Head, [Head, ...UU]>]
    : Unique<Tail, U, UU>
  : []

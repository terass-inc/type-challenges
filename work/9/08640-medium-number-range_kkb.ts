...
> = L extends Count['length']
  ? NumberRange_<L, H, Count>
  : NumberRange<L, H, [unknown, ...Count]>
...
type NumberRange_<
  ...
  Count extends unknown[],
  List extends number[] = []
> = H extends Count['length']
  ? [...List, Count['length']][number]
  : NumberRange_<L, H, [unknown, ...Count], [...List, Count['length']]>

type hoge = NumberRange<1, 4>
type a = Exclude<>

...
type inList<T extends any, U extends any[]> = U extends [infer UH, ...infer UT]
  ? Equal<T, UH> extends true
    ? true
    : inList<T, UT>
  : false

type Unique<T extends any[], U extends any[] = []> = T extends [infer TH, ...infer TT]
  ? inList<TH, U> extends true
    ? Unique<TT, U>
    : Unique<TT, [...U, TH]>
  : U
type hoge = Unique<[string, number, 1, 'a', 1, string, 2, 'b', 2, number]>

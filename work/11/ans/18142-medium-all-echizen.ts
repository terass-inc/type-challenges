...
type All<T extends any[], U> = T extends [infer F, ...infer R] ? (Equal<F, U> extends true ? All<R, U> : false) : true

type T = All<[1, 1, 2], 1>
type T2 = All<[1, 1, 1], 1>
type T3 = All<[any], unknown>

type T4 = any extends unknown ? true : false
type T5 = number extends any ? true : false
type T6 = any extends number ? true : false

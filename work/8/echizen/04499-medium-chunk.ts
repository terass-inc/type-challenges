...
// Resultはイテレーション結果を溜めるためのやつ
type Chunk<T extends any[], N extends number, S extends any[] = [], Result extends any[] = []> =
  // Tが空ならResultを返す
  ...
  T extends []
    ...
    ? // SにFを追加して、長さNになったらResultに追加してSは[]に戻す。まだ長さNでないならSにFを追加して続行
      ...
      ? Chunk<R, N, [], [...Result, [...S, F]]>
      : Chunk<R, N, [...S, F], Result>
    : never

type T = Chunk<[1, 2, 3], 2>
type T2 = Chunk<[1, 2, 3, 4], 5>
